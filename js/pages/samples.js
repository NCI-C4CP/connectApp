...
const health_partners = {
    ...
    locations: [
        ...
        [
            ...
            '<span data-i18n="samples.health_partners.locations.NicolletMinneapolisAddress">2001 Blaisdell Ave <br>Minneapolis, MN 55404 <br><br>Upon entering the building, go to the left and take the stairs or elevator down to the lower-levellobby.In the lower level-lobby, please check-in at the laboratory front desk.</span>',
            '',
...
const henry_ford = {
    ...
    locationNotes: '<span data-i18n="">The table below lists Connect Research Lab and HFH Lab Services locations where you can donate samples for the study.<br><br>If you schedule a visit to donate Connect samples at a Connect Research Lab, you will receive a confirmation email with the address, time / date of your appointment, and parking information.<br><br> Please <a href="https://www.henryford.com/locations/search-results?|#services=&locationtype={6892DD84-8634-4F32-A6C0-8DC0F2E45486}&locationname=&&g=0|0" target="_plank">click here</a> to find address, business hours, and parking information for participating HFH Lab Services locations shown in the table below.</span><br><br><table style="width: 100%;border: 1px solid"><tr style="border: 1px solid"><td style="padding: 10px;vertical-align:top;border: 1px solid"><span class="site-info-bold">Connect Study Research Lab</span> </td><td style="padding: 10px;vertical-align:top;border: 1px solid"><span class="site-info-bold">HFH Lab Services Locations</span> </td></tr><tr style="border: 1px solid"><td style="padding: 10px;vertical-align:top;border: 1px solid">1. HFH Main K13 Research Clinic<br> 2. HFH Medical Center Livonia </td><td style="padding: 10px;vertical-align:top;border: 1px solid">1. HFH Medical Center Brownstown<br>2. HFH Medical Center Columbus<br>3. HFH Detroit Main- K1<br>4. HFH Medical Center Fairlane<br>5. HFH Medical Center Ford Road<br>6. HFH Macomb<br>7. HFH Medical Center New Center One<br>8. HFH Medical Center Plymouth<br>9. HFH Medical Center Royal Oak<br>10.  HFH Medical Center Sterling Heights<br>11. HFH Medical Center Troy<br>12. HFH West Bloomfield<br>13. HFH Wyandotte </td></tr></table>',
    locations: []
};
