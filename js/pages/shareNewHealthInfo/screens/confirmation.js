...
export const renderConfirmation = (content, ctx) => {
    const thankYou = card('shareHealthInfo.reportCancerHeader', 'Report a Cancer Diagnosis', `
        <div class="srcdx-callout" data-screen-heading tabindex="-1">
            <p><span data-i18n="shareHealthInfo.confirmHeader">Thank you for sharing this information with us.</span> <span data-i18n="shareHealthInfo.confirmBody">We are sorry to hear of your diagnosis. If you're interested in additional resources, you may find it useful to review some information about <a href="${CONFIRMATION_LINKS.treatment}" target="_blank" rel="noopener">treatment</a> and <a href="${CONFIRMATION_LINKS.managingCare}" target="_blank" rel="noopener">managing care</a> from the National Cancer Institute. If you have any questions, please reach out to the Connect Support Center.</span></p>
