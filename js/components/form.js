import { allStates, allCountries, getMyData, hasUserData, translateHTML, escapeHTML } from "../shared.js";
        ...
        <form id="userProfileForm" method="POST" autocomplete="off">
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <input data-i18n="form.firstNameField" type="text" value="${escapeHTML(myData.data[cId.consentFirstName])}" class="form-control input-validation row" id="UPFirstName" placeholder="Enter first name" disabled style="max-width:215px;">
                </div>
                <div class="col-md-4">
                    ...
                    <input type="text"  data-i18n="form.middleNameField" value="${
                        myData.data[cId.consentMiddleName] ? escapeHTML(myData.data[cId.consentMiddleName]) : ""
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <input data-i18n="form.lastNameField" type="text" value="${escapeHTML(myData.data[cId.consentLastName])}" class="form-control input-validation row" id="UPLastName" placeholder="Enter last name" disabled style="max-width:304px;">
                </div>
            </div>
