    ...
    "samples": {
        ...
        "health_partners": {
            ...
            "howToDonate": "Connect participants at HealthPartners have two options for donating samples. You can choose the most convenient option for you. There are no co-pays or charges associated with donating samples for Connect."
                ...
                + "<br><br><span class=\"site-info-bold\">Option 2:</span> Make an appointment to come into one of our clinical collection locations detailed below." 
                + "<br><br>"
                ...
                +       "</ol>" 
                +       "</th>"
                +       "<th style=\"width: 50%;border:1px solid\"><span class=\"site-info-bold\">Option 2: HealthPartners Clinical Collection Locations </span><br>" 
                +       "<ol class=\"site-info-italic\">"
                ...
                +           "<td style=\"width: 50%;border:1px solid\">Connect team will greet you and walk you through your visit.</td>"
                +           "<td style=\"width: 50%;border:1px solid\">HealthPartners clinical lab staff will collect your Connect samples.</td>"
                +       "</tr>"
                +       "<tr style=\"border: 1px solid;\">"
                +           "<td style=\"width: 50%;border:1px solid\">The team will draw blood, collect urine, and collect a saliva sample by asking you to swish with mouthwash.<br><br>"
                +           "You will also complete a survey related to the samples we are collecting in MyConnect using your mobile phone. If you do not have a mobile phone, we will provide you with a tablet to complete your survey. You will need your MyConnect login information to complete the survey.</td><td style=\"width: 50%;border:1px solid\">Lab staff will collect blood and urine samples at your visit. You can donate Connect samples and complete any labs ordered by your provider in the same visit. <br><br>Within 48 hours of your sample donation, you will receive an email with a link to a survey to complete on MyConnect. The survey is related to the samples that we collected. <br><br> The Connect team will send you a mouthwash collection kit with instructions to complete your saliva sample at home."
                +           "</td>"
                +       "</tr>"
                +       "<tr style=\"border: 1px solid;\">"
                +           "<td style=\"width: 50%;border:1px solid\">When you receive the scheduling email from the Connect team, please use the link included to schedule an appointment to donate your samples at a time that is convenient for you. You may also call the Connect team at (952) 967-5067 if you would prefer to schedule your appointment over the phone.</td>"
                +           "<td style=\"width: 50%;border:1px solid\">To schedule at one of these locations, please call our team at (952) 967-5067 after you receive the scheduling email from the Connect team.</td>"
                +       "</tr>"
                + "</table>"
                + "<br>For questions, please contact the Connect team at HealthPartners at (952) 967-5067 or ConnectStudy@healthpartners.com.",
