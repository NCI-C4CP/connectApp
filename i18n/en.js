const en = {
    ...
    "samples": {
        ...
        "health_partners": {
            ...
            "howToDonate": "Connect participants at HealthPartners have two options for donating samples. You can choose the most convenient option for you. There are no co-pays or charges associated with donating samples for Connect."
                + "<br><br>"
                + "<span class=\"site-info-bold\">Option 1:</span> Make an appointment to come into our Connect research location, the Park Nicollet Clinic and Specialty Center, to donate your samples."
                + "<br><br>"
                + "<span class=\"site-info-bold\">Option 2:</span> Make an appointment to come into one of our clinical collection locations detailed below."
                + "<br><br>"
                + "When it is time to donate your samples, we will send you an email with a link for more information. If you are interested in donating samples at the Connect research location, simply click the link to schedule a time that works for you. If you prefer to donate samples at one of our HealthPartners clinical collection locations, please call the Connect team at HealthPartners at 952-967-5067. The table below includes more information about these options."
                + "<br><br>"
                + "<table id=\"donateMySamplesTable\" style=\"border: 1px solid;\">"
                +   "<tbody>"
                +     "<tr style=\"border: 1px solid;\">"
                +       "<th class=\"site-info-align\" style=\"width: 50%;border:1px solid\">"
                +         "<span class=\"site-info-bold\">Option 1: Connect Research Location</span>"
                +         "<br>"
                +         "<ol class=\"site-info-italic\">"
                +           "<li>Park Nicollet Clinic and Specialty Center, St. Louis Park</li>"
                +         "</ol>"
                +       "</th>"
                +       "<th style=\"width: 50%;border:1px solid\">"
                +         "<span class=\"site-info-bold\">Option 2: HealthPartners Clinical Collection Locations</span>"
                +         "<br>"
                +         "<ol class=\"site-info-italic\">"
                +           "<li>HealthPartners Riverway Clinic Elk River</li>"
                +           "<li>Park Nicollet Clinic Chanhassen</li>"
                +           "<li>Park Nicollet Clinic Minneapolis</li>"
                +           "<li>HealthPartners Clinic Brooklyn Center</li>"
                +           "<li>HealthPartners Clinic Stillwater</li>"
                +           "<li>New Richmond Clinic, Westfields Hospital & Clinic</li>"
                +           "<li>HealthPartners Clinic St. Paul (Wabasha)</li>"
                +           "<li>Park Nicollet Clinic and Specialty Center, Burnsville</li>"
                +           "<li>HealthPartners Riverway Clinic Andover</li>"
                +         "</ol>"
                +       "</th>"
                +     "</tr>"
                +     "<tr style=\"border: 1px solid;\">"
                +       "<td style=\"width: 50%;border:1px solid\">"
                +         "Connect team will greet you and walk you through your visit."
                +       "</td>"
                +       "<td style=\"width: 50%;border:1px solid\">"
                +         "HealthPartners clinical lab staff will collect your Connect samples."
                +       "</td>"
                +     "</tr>"
                +     "<tr style=\"border: 1px solid;\">"
                +       "<td style=\"width: 50%;border:1px solid\">"
                +         "The team will draw blood, collect urine, and collect a saliva sample by asking you to swish with mouthwash."
                +         "<br><br>"
                +         "You will also complete a survey related to the samples we are collecting in MyConnect using your mobile phone. If you do not have a mobile phone, we will provide you with a tablet to complete your survey. You will need your MyConnect login information to complete the survey."
                +       "</td>"
                +       "<td style=\"width: 50%;border:1px solid\">"
                +         "Lab staff will collect blood and urine samples at your visit. You can donate Connect samples and complete any labs ordered by your provider in the same visit."
                +         "<br><br>"
                +         "Within 48 hours of your sample donation, you will receive an email with a link to a survey to complete on MyConnect. The survey is related to the samples that we collected."
                +         "<br><br>"
                +         "The Connect team will send you a mouthwash collection kit with instructions to complete your saliva sample at home."
                +       "</td>"
                +     "</tr>"
                +     "<tr style=\"border: 1px solid;\">"
                +       "<td style=\"width: 50%;border:1px solid\">"
                +         "When you receive the scheduling email from the Connect team, please use the link included to schedule an appointment to donate your samples at a time that is convenient for you. You may also call the Connect team at 952-967-5067 if you would prefer to schedule your appointment over the phone."
                +       "</td>"
                +       "<td style=\"width: 50%;border:1px solid\">"
                +         "To schedule at one of these locations, please call our team at 952-967-5067 after you receive the scheduling email from the Connect team."
                +       "</td>"
                +     "</tr>"
                +   "</tbody>"
                + "</table>"
                + "<br>"
                + "For questions, please contact the Connect team at HealthPartners at 952-967-5067 or ConnectStudy@healthpartners.com.",
            ...
            "payment": "You will receive your $25 e-gift card  after you donate a blood sample and complete <span class=\"site-info-bold\">all four sections</span> of your first Connect survey.<br><br>You can find the four sections of your first survey within the Surveys card on your MyConnect Dashboard. These sections are:<ol><li>Background and Overall Health</li><li>Medications, Reproductive Health, Exercise, and Sleep</li><li>Smoking, Alcohol, and Sun Exposure</li><li>Where you Live and Work</li></ol>",
            "support": "Call 1-877-505-0253 (8:00 a.m.–10:00 p.m. CT on weekdays and 9:00 a.m.–6:00 p.m. CT on weekends)",
            "locations": {
                "RiverwayElkName": "HealthPartners Riverway Clinic Elk River",
                "RiverwayElkAddress": "530 3<sup>rd</sup> St NW<br>Elk River, MN 55330<br><br>Upon arrival, proceed past the main check in desk and go directly to the lab check in desk.",
                "RiverwayElkParking": "Parking is free in the Elk River Clinic parking lot.<br><br><div class=\"messagesSubHeader\">Scheduling Information</div>Self-scheduling is not currently available for the Elk River location. For questions and scheduling, please call 952-967-5067",
                ...
                "NicolletClinicParking": "Parking at the Park Nicollet Clinic and Specialty Center is free in the visitor parking ramp. <br><br><div class=\"messagesSubHeader\">Scheduling Information</div>You can self-schedule using the link included in the scheduling email sent from the Connect team. For questions or to schedule over the phone, please call 952-967-5067.",
                "NicolletName": "Park Nicollet Clinic Chanhassen",
                "NicolletAddress": "300 Lake Dr E<br>Chanhassen, MN 55317 <br><br>Upon arrival, please take the stairs or elevator to the 2<sup>nd</sup> floor and check in for your appointment at the lab check in desk.",
                "NicolletParking": "Parking is free in the Chanhassen Clinic parking lot.<br><br><div class=\"messagesSubHeader\">Scheduling Information</div>Self-scheduling is not currently available for the Chanhassen location. For questions and scheduling, please call 952-967-5067.",
                ...
                "NicolletMinneapolisParking": "Parking is free and available at the front entrance or across the street.<br><br><div class=\"messagesSubHeader\">Scheduling Information</div>Self-scheduling is not currently available for the Minneapolis location. For questions and scheduling, please call 952-967-5067. ",
                ...
                "BrooklynCenterParking": "Free parking is available on-site at the front of the building.<br><br><div class=\"messagesSubHeader\">Scheduling Information</div>Self-scheduling is not currently available for the Brooklyn Center location. For questions and scheduling, please call 952-967-5067.",
                ...
                "ClinicalStillwaterParking": "Free parking is available on-site at the front of the building.<br><br><div class=\"messagesSubHeader\">Scheduling Information</div>Self-scheduling is not currently available for the Stillwater location. For questions and scheduling, please call 952-967-5067.",
                ...
                "NewRichmondClinicParking": "Free parking is available on-site at the front of the building.<br><br><div class=\"messagesSubHeader\">Scheduling Information</div>Self-scheduling is not currently available for the New Richmond location. For questions and scheduling, please call 952-967-5067.",
                "ClinicStPaulWabashaName": "HealthPartners Clinic St. Paul (Wabasha)",
                "ClinicalStPaulWabashaAddress": "205 Wabasha St S <br> St Paul, MN 55107 <br><br> Upon arrival, enter the clinic main doors and turn left. Walk past the main clinic greet station and follow signs to the lab greet station, which is located on the main floor of the clinic.",
                "ClinicalStPaulWabashaParking": "Free parking is available on-site at the front of the building.<br><br><div class=\"messagesSubHeader\">Scheduling Information</div> Self-scheduling is not currently available for the St. Paul (Wabasha) location. For questions and scheduling, please call 952-967-5067.",
                "NicolletBurnsvilleName": "Park Nicollet Clinic and Specialty Center, Burnsville",
                "NicolletBurnsvilleAddress": "14000 Fairview Dr<br>Burnsville, MN 55337 <br><br>Upon entering the 14050 building, follow the 14000 building signage until you come to the elevators or stairs. The lab is on the second floor.",
                "NicolletBurnsvilleParking": "Parking at the Park Nicollet Specialty Center is free in the visitor parking ramp.<br><br><div class=\"messagesSubHeader\">Scheduling Information</div>Self-scheduling is not currently available for the Burnsville location. For questions and scheduling, please call 952-967-5067.",
                "RiverwayAndoverName": "HealthPartners Riverway Clinic Andover",
                "RiverwayAndoverAddress": "15245 Bluebird St NW <br> Andover, MN 55304 <br><br>Upon arrival, enter the clinic’s main doors and check in at the clinic front desk.",
                "RiverwayAndoverParking": "Parking is free and available in the front of the clinic.<br><br><div class=\"messagesSubHeader\">Scheduling Information</div>Self-scheduling is not currently available for the Andover location. For questions and scheduling, please call 952-967-5067."
            }
        },
        "sanford": {
        ...
        "henry_ford": {
            "donatingSamples": "Thank you for being part of the Connect for Cancer Prevention Study. As part of the study, we ask you to donate blood, urine, and mouthwash samples and complete two short surveys.",
            ...
            "howLong": "<br>Wait times to donate samples may vary by location. To better serve HFH patients, Henry Ford Lab Services have started using “Save My Spot”."
            ...
            "whatHappensDuring": "Donating your research blood and urine samples is just like providing samples requested by your health care provider. When you arrive at the clinic, you may go directly to the lab and check in with front desk staff. When it is your turn, the lab will call you back and collect your samples. The lab techs will be able to see your blood and urine collection orders and instructions for Connect in their system.",
            "whatHappensAfter": "Within a day of your blood and urine collection, we will send you an email asking you to complete a short survey on MyConnect. The survey will ask about recent actions such as:"
                +                   "<br><br>"
            ...
            "howToDonateMouthwash": "We will send you an email as soon as your mouthwash home collection kit is on the way. Once you receive the kit, you can collect your mouthwash sample in the comfort of your own home. The kit we mail you will include instructions and all of the items needed to collect your sample, including a return shipping box with a pre-paid shipping label to return your sample to us."
                +                   "<br><br>"
        ...
        "bswh": {
            ...
            "support": "Call 1-877-505-0253 (8:00 a.m. - 10:00 p.m. CT on weekdays and 9:00 a.m. - 6:00 p.m. CT on weekends).",
            "locationNotes": "<div style=\"margin-bottom:2rem;\"><div><span class=\"site-info-bold\">Baylor Scott & White Health and Wellness Center - Dallas</span><p>4500 Spring Ave.<br>Dallas, TX 75210<br><br>Parking Instructions: The site offers free surface level parking.</p></div><div><span class=\"site-info-bold\">Baylor Scott & White Community Care (BCC) - Fort Worth*</span><p>1307 8th Ave., Suite 305<br>Fort Worth, TX 76104<br><br>Parking Instructions: The site offers free surface level parking.<br><span style=\"font-size:1rem\" class=\"site-info-underline-italic\">*Note: Only patients of Baylor Scott & White Health Community Care - Fort Worth clinic can schedule an appointment at this location.</span></p></div><div><span class=\"site-info-bold\">Baylor Scott & White All Saints Hospital - Fort Worth</span><p>1400 8th Ave.<br>Fort Worth, TX 76104<br>6th Floor, C Building<br><br>Parking Instructions: Park in self-parking garage located on the corner of 8th Avenue and Enderly Place. Parking is free for the first hour. Once parked, look for main hospital entrance and navigate to Building C.</p></div><div><span class=\"site-info-bold\">Baylor Scott & White Community Care (BCC) - Worth Street Clinic*</span><p>4001 Worth St.<br>Dallas, TX 75246<br><br>Parking Instructions: The site offers free surface level parking.<br><span style=\"font-size:1rem\" class=\"site-info-underline-italic\">*Note: Only patients of Baylor Scott & White Health Community Care - Worth Street clinic can schedule an appointment at this location.</span></p></div><div><span class=\"site-info-bold\">Baylor Scott & White Sammons Cancer Center</span><p>3410 Worth St., Suite 530<br>Dallas, TX 75246<br><br>Parking Instructions: Drive to the back of the Sammons Cancer Center Building and park in the underground garage. You will get a ticket from the machine as you enter the garage. Please keep the ticket. During your visit, the Connect team will give you a voucher for free parking.</p></div><div><span class=\"site-info-bold\">Baylor Scott & White North Garland Clinic</span><p>7217 Telecom Pkwy., Suite 100<br>Garland, TX 75044<br><br>Parking Instructions: The site offers free surface level parking.</p></div><div><span class=\"site-info-bold\">Baylor Scott & White Medical Center - Irving</span><p>1901 N. MacArthur Blvd., Suite 115<br>Irving, TX 75061<br><br>Parking Instructions: The site offers free surface level parking<br>Suite 115 is located within the Irving Hospital in the PAT lab.</p></div><div><span class=\"site-info-bold\">Baylor Scott & White Center for Diagnostic Medicine – Temple CDM</span><p>1605 S. 31st St.<br>Temple, TX 76508<br><br>Parking Instructions: The site offers free surface level parking.</p></div><div><span class=\"site-info-bold\">Baylor Scott & White, Temple Roney Bone & Joint – Temple Roney</span><p>2401 S. 31st St., Bldg 35<br>Temple, TX 76508<br><br>Parking Instructions: The site offers free surface level parking.</p></div><div><span class=\"site-info-bold\">Baylor Scott & White Temple Westfield Clinic</span><p>7556 Honeysuckle<br>Temple, TX 76502<br><br>Parking Instructions: The site offers free surface level parking.</p></div><div><span class=\"site-info-bold\">Baylor Scott & White - Waco Fish Pond</span><p>7700 Fish Pond Rd.<br>Waco, TX 76710<br><br>Parking Instructions: The site offers free surface level parking.</p></div></div>",
            ...
            "whatHappens": "<p>The research team will check you in for your appointment and then collect your samples. At the end of your visit, the research team will check you out of your appointment.</p><p>We will draw a blood sample, collect a urine sample, and collect a saliva sample by asking you to swish with mouthwash.</p><p>We will also ask you to complete a short survey about your samples on MyConnect using your mobile phone. You will need your MyConnect login information to complete the survey. If you do not have a mobile phone, we will provide you with a tablet to complete your survey. We strongly encourage you to complete your survey at your appointment. If you choose to complete it after you leave your appointment, it is important to do so as soon as possible.</p>",
            "payment": "You will receive your $25 payment after you donate a blood sample and complete all four sections of your first Connect survey.<br><br>You can find the four sections of your first survey on your MyConnect Dashboard. These sections are:<br><br><ol><li class=\"site-list-item-spacing\">Background and Overall Health</li><li class=\"site-list-item-spacing\">Medications, Reproductive Health, Exercise, and Sleep</li><li class=\"site-list-item-spacing\">Smoking, Alcohol, and Sun Exposure</li><li class=\"site-list-item-spacing\">Where you Live and Work</li></ol>"
        }
    },
    "settings": {
