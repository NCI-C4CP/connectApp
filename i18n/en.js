const en = {
    ...
    "samples": {
        ...
        "health_partners": {
            ...
            "locations": {
                ...
                "NicolletMinneapolisAddress": "2001 Blaisdell Ave <br>Minneapolis, MN 55404 <br><br>Upon entering the building, go to the left and take the stairs or elevator down to the lower-levellobby.In the lower level-lobby, please check-in at the laboratory front desk.",
    ...
    "reports": {
        ...
        "physicalActivityDescription": "<p>Engaging in regular physical activity is important for your health. Evidence suggests that higher levels of physical activity <a href=\"https://www.cancer.gov/about-cancer/causes-prevention/risk/obesity/physical-activity-fact-sheet#what-is-known-about-the-relationship-between-physical-activity-and-cancer-risk\">reduce the risk</a> of chronic diseases, including certain cancers. However, there is much more to learn about the relationship between physical activity and cancer risk. Connect is designed to better understand the lifestyle and behavior patterns that may affect cancer risk over the life course. Physical activity is one area of active research interest that we are focusing on.</p><p>We asked questions about how often you engaged in different activities in the first Connect survey. Based on your responses, we put together a report that describes how your activity levels compare to the national physical activity guidelines.</p>",
        ...
        "physicalActivityIntroStart": "This report is based on your answers to questions about your recreational physical activity in the first Connect survey, completed on ",
